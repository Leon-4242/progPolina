...
public:
    ...
    virtual double derivative_x(double x, double y) const = 0;
    virtual double derivative_y(double x, double y) const = 0;
    virtual double derivative_xy(double x, double y) const = 0;
...
double compute_derivative_y_infinity_norm(
    const abstract_function_2d* func, double a, double b, double c, double d, int n_steps_x = 50, int n_steps_y = 50);
double compute_derivative_xy_infinity_norm(
    const abstract_function_2d* func, double a, double b, double c, double d, int n_steps_x = 50, int n_steps_y = 50);
...
public:
    ...
    virtual double derivative_x(double x, double y) const override;
    virtual double derivative_y(double x, double y) const override;
    virtual double derivative_xy(double x, double y) const override;
...
public:
    ...
    virtual double derivative_x(double x, double y) const override final;
    virtual double derivative_y(double x, double y) const override final;
    virtual double derivative_xy(double x, double y) const override final;
...
class residual_function_2d final : public abstract_function_2d
{
public:
    residual_function_2d(const abstract_function_2d* func, const abstract_function_2d* approx);
    virtual double evaluate(double x, double y) const override;
    virtual double derivative_x(double x, double y) const override;
    virtual double derivative_y(double x, double y) const override;
    virtual double derivative_xy(double x, double y) const override;
