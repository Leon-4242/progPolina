...
private:
  ...
  draw_mode_t m_draw_mode = draw_mode_t::function_1;
  function_1d m_func;
  Newton_linear_interpolation_function_1d m_Newton_linear_interpolation;
  ...
  residual_function_1d m_Newton_linear_residual;
